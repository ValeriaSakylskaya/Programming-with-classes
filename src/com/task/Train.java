...
public class Train {
    ...
    {
        for (Train t : trains) { if (t.getNumberOfTrain().equals(number)) { System.out.println(t.toString());}}
    }
    ...
    public void sortByDestination (Train [] trains)
    {
        Arrays.sort(trains, new Comparator<Train>() {
            @Override
            public int compare(Train o1, Train o2) {
               if ( o1.getDestination()== o2.getDestination()) { return o1.getTime().compareTo(o2.getTime());}
